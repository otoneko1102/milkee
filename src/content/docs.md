...
A simple CoffeeScript build tool with [coffee.config.cjs](https://github.com/otoneko1102/coffeescript-milkee/blob/main/temp/coffee.config.cjs)  
...
Run `-s` (`--setup`) command, generate [coffee.config.cjs](https://github.com/otoneko1102/coffeescript-milkee/blob/main/temp/coffee.config.cjs)!  
